...
uint32_t NPC_Record::GetFieldAttribute(DEFAULTED_FIELD_IDENTIFIERS, uint32_t WhichAttribute = 0)
{
    switch (FieldID)
    {
    case 0: //recType
...
void * NPC_Record::GetField(DEFAULTED_FIELD_IDENTIFIERS, void **FieldValues = NULL)
{
    switch (FieldID)
    {
    case fMajorFlags:
...
bool NPC_Record::SetField(DEFAULTED_FIELD_IDENTIFIERS, void *FieldValue = NULL, uint32_t ArraySize = 0)
{

}

void NPC_Record::DeleteField(DEFAULTED_FIELD_IDENTIFIERS)
{
