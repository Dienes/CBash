...
namespace Sk
{
    ...
    private:
        ...
        {
            // skill values
            int16_t OneHanded, TwoHanded, Marksman, Block, Smithing, HeavyArmor,
            ...
            //skill offsets
            int16_t OneHandedOff, TwoHandedOff, MarksmanOff, BlockOff, SmithingOff, HeavyArmorOff,
    ...
    public:
        ...
        ReqSubRecord<ACBS> ACBS;  // configuration
        ...
        OptCounted<UnorderedSparseArray<FORMID>, int16_t, REV32(SPCT)> SPLO; // Actor effects
        ...
        OptCounted<UnorderedSparseArray<SKCNTOCOED *>, int32_t, REV32(COCT)> CNTO; // items
        ...
        ReqSubRecord<FORMID> NAM5; // unknown?
